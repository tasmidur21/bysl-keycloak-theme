...
<div class="card-heading" style="background: url('${url.resourcesPath}/img/1.jpg') top left/cover no-repeat"> 
</div>
<#if realm.password>
<div class="card-body">
<div style="text-align:center;">
   <img  src="https://bysl.live/assets/media/login/bysl.png" alt="logo" style="height:60px;">
</div>
...
<form id="kc-form-login" class="form form1" return true;" action="${url.loginAction}" method="post">
   <div class="input-group">
      ...
      <div>
         <input id="username" class="input--style-3 input-width" type="text" placeholder="Username/Email" name="username">
      </div>
   </div>
   <div class="input-group">
